...
/*
 ...
 Transofrm and display nearly any arbitrary DocC document from the Apple online Dev Docs. Additionally format for speech synthesis, send text, receive audio sample buffers, play buffers w/ AVFAudio or whatever makes sense. Maybe just hook this into my menubar TTS service. Would be cool to use ExtensionKit to provide a plugin architecture for this... could be for all sorts of docs and shitty inaccessibly websites, but that's down the road I guess... Someday I'll have built my accessible, high-quality suite of productivity software that's actually useful and not stupidly expensive and horrible... Someday after that I'll wake up and wonder when tf I decided to build an entire OS for collaboration and distributed computing that isn't the hot garbage built atop three decades of tech debt in C/C++ that we're stuck with today...
 Someday...
 For now though, I guess I'll go back to building in the open. I'll try to stay eternally motivated with the tiny scopes this industry, and this world, pressure me to limit myself to. Despite the need for the very things I dream of building, but never have the support to build. I'd hate to be too ambitious, of course, nobody likes that. I wonder why we never get shit that works, written from scratch... Oh, maybe that's why...
 Rambling alone to my own fucking block comments. Definitely not a high point for me, but whatever. Should scare off the "dream small, don't be weird or rock the boat" crowd, and that's always a good thing. Idgaf what anyone thinks, I'm building good software that fixes the problems everyone else says are too big to bother with. You're either with me, or you're getting left tf behind. Pick a side, or step aside.
 */
