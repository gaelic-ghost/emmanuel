...
// "Disclaimers" here
This is a mess. I am, for the time being, also a mess. It's day one on this, I've read enough to cause me a lot of pain, and I wasn't doing great to begin with. That said, I do intend to have this shipshape very soon.
If you want a clean, organized look at where this trainwreck is going, check back in a week or so, idk.

Yes, I use namings such as "Model", "View", and "Controller". Nearly everything is MVC if you think about it, and MVC is the most comfy of it's variants to say or read for me, personally.
...
make an importer for that, actually, add it to the auto-organizer that works in the template
...
If this someday become the massive, next-gen edu ecosystem I wish I'd had trying to learn any of this myself, then I guess I'll need to revisit the pricing model at that point.


// Thoughts, brainstorming, whatever

I just wanted an accessible way to find/read/listen-to the various sources and types of dev docs for this stuff.
Then I just wanted to build accessibility into the docs infrastructure.
It's become clear that I just have to build it all myself, so this is me starting to do that in a relatively reaosnable way, considering the hurdling inherent in a project like this.
...
"Where am I?" button with helpful feedback...
Sections on how things connecy together...
Maybe some nice illusrations of different patterns... idk...
