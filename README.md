...
It's become clear that I just have to get back to building it all myself, so this is me starting to do that again.

I really wish Speechify or Apple could have managed to ship a functioning screen reader for macOS over the past year or two, but they clearly can't, and I'm done waiting. I'll build this into an entire browser if I have to, which is proabbly a decent idea with the state of the neo-browser market...
